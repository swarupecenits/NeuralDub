    ...
    <main className="min-h-screen bg-[#0A1628] flex items-center justify-center pt-20 pb-20 px-4">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Join Neural Dub and start translating</p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div>
              ...
              {formData.password && (
                <div className="mt-3 space-y-2">
                  <p className="text-xs font-semibold text-gray-300 mb-2">Password strength</p>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-1 rounded border-white/20 bg-[#0A1628] cursor-pointer"
                required
              />
